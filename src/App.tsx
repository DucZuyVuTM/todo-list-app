...
const App: React.FC = () => {
  ...
  return (
    <div className="max-w-xl w-full bg-white p-5 rounded-lg shadow-lg box-border">
      ...
      <div className="flex justify-center gap-2 mb-4">
        ...
        <button
          ...
          className={`px-3 py-1 rounded-lg ${filter === "active" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
        >
          Active
        </button>
        <button
            ...
            {editingId === todo.id ? (
              ...
              <>
                ...
                <span
                  ...
                  className={`flex-1 overflow-x-scroll [scrollbar-width:none] ${todo.completed ? "line-through text-gray-500" : ""}`}
                >
                  {todo.text}
                </span>
                <button
